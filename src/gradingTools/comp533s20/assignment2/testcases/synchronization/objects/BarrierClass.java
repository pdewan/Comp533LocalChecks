...
//		}
		if (!PartitionerClass.testForCorrectPackageName(barrierClass)) {
			return partialPass(0.5, "Barrier class package name, " + barrierClass + ",  does not start with:" + ConfigurationProvided.TOP_LEVEL_PACKAGE_NAME + ". ");
		}
		return pass();
