...
import gradingTools.comp533s20.assignment5.testcases.GIPCRMIOneClientConnection;
import gradingTools.comp533s20.assignment5.testcases.GIPCRMIOneClientReadWriteAtomic;
import gradingTools.comp533s20.assignment5.testcases.GIPCRMIOneClientReadWriteNonAtomic;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ GIPCRMIStaticArguments.class, GIPCRMIOneClientConnection.class,
	GIPCRMIOneClientReadWriteNonAtomic.class
//		, GIPCRMIOneClientReadWriteAtomic.class
...
public class Assignment5OneClientSuite {
	...
	public static void oneClientSetupProcesses(boolean doGIPC) {
		Assignment5OneClientSuite.oneClientSetupProcesses(FlexibleStaticArgumentsTestCase.TEST_SERVER_ARGS,
