...
@MaxValue(20)
public class A6ExpectedCalls extends ExpectedCallsRatioCheck{
	 public A6ExpectedCalls() {
		 super();
	 }
	...
	public TestCaseResult test(Project aProject, boolean autoGrade) throws NotAutomatableException, NotGradableException {
			...
			A6TaggedClassesDefined aTaggedClassesDefined = (A6TaggedClassesDefined) JUnitTestsEnvironment.getAndPossiblyRunGradableJUnitTest(A6TaggedClassesDefined.class);
