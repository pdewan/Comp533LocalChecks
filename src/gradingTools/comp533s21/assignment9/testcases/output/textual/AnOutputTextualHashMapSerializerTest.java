...
@MaxValue(5)
public class AnOutputTextualHashMapSerializerTest extends AnOutputTextualSerializerTest{
	@Override
	protected SubstringSequenceChecker checker() {
		 
		return new ASerializationTraceChecker(taggedClass(), "4.0.*ni hao", "5=4.0, greeting=ni hao" );
	}
//	@Override
