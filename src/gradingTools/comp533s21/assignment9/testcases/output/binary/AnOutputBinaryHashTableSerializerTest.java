...
@MaxValue(5)
public class AnOutputBinaryHashTableSerializerTest extends AnOutputBinarySerializerTest{
	@Override
	protected SubstringSequenceChecker checker() {
		 
		return new ASerializationTraceChecker(taggedClass(), "HeapByteBuffer", "5=2.0, greeting=ni hao" );
	}
//	@Override
