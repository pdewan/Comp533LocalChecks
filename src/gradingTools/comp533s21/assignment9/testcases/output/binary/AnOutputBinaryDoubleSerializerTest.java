...
@MaxValue(5)
public class AnOutputBinaryDoubleSerializerTest extends AnOutputBinarySerializerTest{
	@Override
	protected SubstringSequenceChecker checker() {
		 
		return new ASerializationTraceChecker(taggedClass(), "HeapByteBuffer", "5.5" );
	}
//	@Override
...
//	}
	...
	protected String classTag() {
		...
		return Comp533Tags.DOUBLE_SERIALIZER;
	}
