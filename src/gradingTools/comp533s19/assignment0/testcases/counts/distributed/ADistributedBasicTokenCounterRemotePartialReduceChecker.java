...
//				AMapReduceTracer.CONTROLLER + ".*" + AMapReduceTracer.QUIT,
				...
				toRegex(DistributedTokenCountResult.MAP_REDUCE_CLIENT_1 + ".*" + "RMI TCP Connection" +   ".*:.*" + "RemoteList"),
				toRegex(DistributedTokenCountResult.MAP_REDUCE_CLIENT_1 + ".*" + "RMI TCP Connection" +   ".*:.*" + "reduce:"),
			    toRegex(DistributedTokenCountResult.MAP_REDUCE_SERVER + ".*" + AMapReduceTracer.SLAVE +  "2" + ".*" + AMapReduceTracer.DEQUEUE + ".*" + "Remote Result"),
