package gradingTools.comp533s19.assignment0.testcases.counts.distributed.partial_reduce;
...
public class ADistributedTokenCountPartialReduceChecker extends ASubstringSequenceChecker{
...
//			toPrefixedRegex("I\\*\\*\\*", "Selecting Thread..ReceivedReturnValueQueued")	
	...
	public ADistributedTokenCountPartialReduceChecker(String aClientName, String aSlaveName) {
