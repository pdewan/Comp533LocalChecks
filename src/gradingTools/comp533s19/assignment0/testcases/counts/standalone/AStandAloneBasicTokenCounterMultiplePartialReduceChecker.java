...
public class AStandAloneBasicTokenCounterMultiplePartialReduceChecker extends ASubstringSequenceChecker{
...
//			toPrefixedRegex("I\\*\\*\\*", "Selecting Thread..ReceivedReturnValueQueued")	
	...
	public AStandAloneBasicTokenCounterMultiplePartialReduceChecker() {
		init( MY_SUBSTRINGS);
	}
