...
public class AStandAloneBasicTokenCounterPartialReduceChecker extends ASubstringSequenceChecker{
...
//			toPrefixedRegex("I\\*\\*\\*", "Selecting Thread..ReceivedReturnValueQueued")	
	...
	public AStandAloneBasicTokenCounterPartialReduceChecker() {
		init( MY_SUBSTRINGS);
	}
