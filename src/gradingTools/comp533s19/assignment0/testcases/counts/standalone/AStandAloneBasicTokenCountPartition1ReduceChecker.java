...
public class AStandAloneBasicTokenCountPartition1ReduceChecker extends ASubstringSequenceChecker{
...
//	};
	...
	public AStandAloneBasicTokenCountPartition1ReduceChecker() {
		init( mySubstrings());
	}
