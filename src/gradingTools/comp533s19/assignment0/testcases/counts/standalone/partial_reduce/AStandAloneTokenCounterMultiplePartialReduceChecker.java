...
public class AStandAloneTokenCounterMultiplePartialReduceChecker extends ASubstringSequenceChecker{
...
//			toPrefixedRegex("I\\*\\*\\*", "Selecting Thread..ReceivedReturnValueQueued")	
	...
	public AStandAloneTokenCounterMultiplePartialReduceChecker() {
		init( MY_SUBSTRINGS);
	}
