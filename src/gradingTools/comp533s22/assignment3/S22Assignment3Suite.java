package gradingTools.comp533s22.assignment3;
...
public class S22Assignment3Suite extends Assignment1Suite{
	...
	public static void main (String[] args) {
		try {
			BasicJUnitUtils.interactiveTest(S22Assignment3Suite.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
