package gradingTools.comp533s22.assignment6;
...
public class S22Assignment6Suite extends Assignment2Suite{
	...
	public static void main (String[] args) {
		try {
			...
			BasicJUnitUtils.interactiveTest(S22Assignment6Suite.class);
