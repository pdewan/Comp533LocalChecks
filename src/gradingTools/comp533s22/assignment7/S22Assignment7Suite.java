package gradingTools.comp533s22.assignment7;
...
public class S22Assignment7Suite extends Assignment2Suite{
	...
	public static void main (String[] args) {
		try {
			...
			BasicJUnitUtils.interactiveTest(S22Assignment7Suite.class);
